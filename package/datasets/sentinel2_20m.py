...
class Sentinel2_20m(RasterDataset):
    """
...
# How to use (from project root): $ python -m package.datasets.sentinel2_20m data masks
if __name__ == "__main__":
    img = Sentinel2_20m(argv[1], products=PRODUCTS)
