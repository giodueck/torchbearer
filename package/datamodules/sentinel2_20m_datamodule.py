...
from ..datasets import Sentinel2_20m, LabelDataset
...
class Sentinel2_20mDataModule(GeoDataModule):
    def __init__(
        self,
        batch_size=16,
        patch_size=64,
...
def createSentinel2_20mDataModule(params: dict):
    """
    Returns a configured Sentinel2_20mDataModule.

    If params contains a parameter for Sentinel2_20mDataModule, it is used,
    otherwise it is set to a default value. Inexistant parameters are ignored.
    """
    datamodule = Sentinel2_20mDataModule(
